...
//add by wangpl for bug259001
		bcm_gpio_pull_up(pdata->sda_pin, true);
		bcm_gpio_pull_up_down_enable(pdata->sda_pin, true);
//end	
		}
	else
...
//add by wangpl for bug259001
		bcm_gpio_pull_up(pdata->scl_pin, true);
		bcm_gpio_pull_up_down_enable(pdata->scl_pin, true);
//end
		}
	else

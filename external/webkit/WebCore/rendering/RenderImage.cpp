...
void RenderImage::paintReplaced(PaintInfo& paintInfo, int tx, int ty)
{
    ...
    if (!hasImage() || errorOccurred()) {
        ...
        if (cWidth > 2 && cHeight > 2) {
            ...
            //huaidi.feng modified for bug 220180 to not display the rect
            ...
            //huaidi.feng modified for bug for bug 220180 when have alt text not display the broken Image.
            ...
            if (!m_altText.isEmpty()) {
                ...
                //huaidi.feng modified for bug 220180 begin display alt text begin
               ...
               //     context->drawText(style()->font(), textRun, IntPoint(ax, ay + ascent));
                //huaidi.feng modified for bug 220180 begin display alt text end
            }
        }

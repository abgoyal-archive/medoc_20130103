...
bool RenderBlock::handleRunInChild(RenderBox* child)
{
    ...
    //huaidi.feng porting from webkit changeSet 100677 for bug 248611 begin
    ...
    //huaidi.feng porting from webkit changeSet 100677 for bug 248611 end
    ...
    ////huaidi.feng porting from webkit changeSet 59357 for bug 248611 begin
    ...
    //huaidi.feng porting from webkit changeSet 59357 for bug 248611 end
       ...
       // }
        ...
        blockRunIn->children()->removeChildNode(blockRunIn, runInChild, false);
        inlineRunIn->addChild(runInChild); // Use addChild instead of appendChildNode since it handles correct placement of the children relative to :after-generated content.
        runInChild = nextSibling;  //huaidi.feng porting from webkit changeSet 59357 for bug 248611
    //huaidi.feng porting from webkit changeSet 100677 for bug 248611 end
    }

...
#include "HTMLNames.h"           //Add by wei.cao for bug 238813.
...
void ImageLoader::updateFromElement()
{
    ...
    //Add by wei.cao for bug 238813 begin.
    AtomicString codebase =  m_element->getAttribute(HTMLNames::codebaseAttr);
    attr = codebase + attr;
    //Add by wei.cao for bug 238813 end.
